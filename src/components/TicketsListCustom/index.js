...
const TicketsListCustom = (props) => {
  ...
  useEffect(() => {
    dispatch({ type: "RESET" });
    setPageNumber(1);
  }, [status, searchParam, dispatch, showAll, orderBy, tags, users, selectedQueueIds]);
  ...
  useEffect(() => {
    ...
    const shouldUpdateTicket = (ticket) =>
      ...
      user.whatsappId == ticket.whatsappId;
    ...
    socket.on(`company-${companyId}-appMessage`, (data) => {
      if (user.whatsappId !== data.ticket?.whatsappId) return;
